...
cl /nologo /EHsc /std:c++20 /utf-8 /O2 /I LayerForge /I "%ORT%\build\native\include" ^
  Tests\Phase4JSmartTest.cpp LayerForge\ImageLoader.cpp LayerForge\AI\AIModelManager.cpp ^
  ...
  LayerForge\Editor\SmartMaskCorrection.cpp ^
  /Fe:x64\Release\Phase4JSmartTest.exe /link /LIBPATH:"%ORT%\runtimes\win-x64\native" onnxruntime.lib windowscodecs.lib ole32.lib
if errorlevel 1 exit /b %errorlevel%
