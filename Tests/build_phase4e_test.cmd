...
cl /nologo /EHsc /std:c++20 /utf-8 /O2 /I LayerForge /I "%ORT%\build\native\include" ^
  Tests\Phase4EPipelineTest.cpp LayerForge\ImageLoader.cpp LayerForge\AI\SegmentationModel.cpp ^
  LayerForge\AI\MaskProcessor.cpp LayerForge\AI\GroundingDinoModel.cpp LayerForge\AI\HairBoxFilter.cpp LayerForge\AI\InferenceDevice.cpp LayerForge\AI\Sam2Model.cpp ^
  /Fe:x64\Release\Phase4EPipelineTest.exe /link /LIBPATH:"%ORT%\runtimes\win-x64\native" onnxruntime.lib windowscodecs.lib ole32.lib
if errorlevel 1 exit /b %errorlevel%
